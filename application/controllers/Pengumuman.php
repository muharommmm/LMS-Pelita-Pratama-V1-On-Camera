...
class Pengumuman extends CI_Controller {
    ...
    public function index() {
        ...
        $data['kelas'] = $this->dropdown->getAllKeyKodeKelas($tp->id_tp, $smt->id_smt);
    ...
    public function kepada($kepada, $id_kepada = null) {
        ...
        // Filter visibility if logged in user is a Guru
        if (!$this->ion_auth->is_admin()) {
            $guru = $this->dashboard->getDataGuruByUserId($user->id, $tp->id_tp, $smt->id_smt);
            $this->db->group_start();
            $this->db->where('a.dari', $guru->id_guru);
    ...
    public function getPost() {
        ...
        if ($this->ion_auth->is_admin()) {
            ...
            $smt = $this->master->getSemesterActive();
            $guru = $this->dashboard->getDataGuruByUserId($user->id, $tp->id_tp, $smt->id_smt);
            $post = $this->post->getPostForGuru($guru->id_guru);
        }
