...
<div class="content-wrapper bg-white">
    <section class="content-header p-0 d-flex align-items-end"
             style="height: 400px; background: url('<?= base_url('assets/img/1.png') ?>')">
        <div class="container-fluid pl-0 pr-0 pb-0 pt-4" style="background-color: rgba(219, 255, 14, 0.79)">
            <div class="row m-0">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-4">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            foreach ($kelases as $ky => $kelas) :
                                                ...
                                                <div class="tab-pane <?= $active ?>" id="tab_<?= $ky ?>">
                                                    <?php if (isset($jadwals[$ky]) && count($jadwals[$ky]) > 0) : ?>
                                                          <div class="table-responsive">
                                                              <table class="w-100 table table-bordered table-sm">
                                                                  ...
                                                                  <tr>
                                                                      ...
                                                                      <th class="text-center align-middle">MATA
                                                                          PELAJARAN
                                                                      </th>
                                                                  </tr>
                                                                  </thead>
                                                                  ...
                                                                  <?php
                                                                  $jamke = 1;
                                                                  foreach ($jadwals[$ky] as $jdw) :
                                                                  ?>
                                                                          <tr>
                                                                              <td class="text-center align-middle"><?= $jamke++ ?></td>
                                                                              <td class="text-center align-middle"><?= date('H:i', strtotime($jdw->start_time)) ?>
                                                                                  - <?= date('H:i', strtotime($jdw->end_time)) ?></td>
                                                                              <td class="text-center align-middle">
                                                                                  <?= isset($jdw->kode) && $jdw->kode != null ? $jdw->kode : ($jdw->nama_mapel ?: '--') ?>
                                                                              </td>
                                                                          </tr>
                                                                  <?php endforeach; ?>
                                                                  </tbody>
                    ...
                    $active_agendas = $CI->agenda_helper->get_agendas_by_role('admin');
                    ?>
                    <div class="card card-info my-shadow mb-3">
                        <div class="card-header">
                            <div class="card-title">AGENDA TERDEKAT</div>
                            <div class="card-tools">
                                <a href="<?= base_url('agendas') ?>" class="btn btn-sm"><i class="fa fa-arrow-circle-right text-white"></i></a>
                            </div>
                        </div>
