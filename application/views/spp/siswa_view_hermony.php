...
<div class="flex max-w-[1280px] mx-auto w-full">
    ...
    <main class="flex-1 p-container-padding-mobile md:p-container-padding-desktop pb-24 lg:pb-container-padding-desktop">
        <div class="max-w-4xl mx-auto space-y-6">
            <!-- Header -->
            <div>
                <h2 class="text-2xl font-bold font-headline text-primary">Tagihan & Pembayaran SPP</h2>
                <p class="text-xs text-on-surface-variant mt-1">Siswa: <?= htmlspecialchars($siswa->nama) ?> &bull; NIS: <?= htmlspecialchars($siswa->nis) ?></p>
            </div>

            <!-- SPP History Table (Under Construction) -->
            <section class="lumina-card overflow-hidden">
                <div class="p-8 text-center flex flex-col items-center justify-center min-h-[40vh]">
                    <span class="material-symbols-outlined text-6xl text-secondary mb-4">construction</span>
                    <h3 class="font-headline text-xl font-bold text-primary mb-2">Fitur Masih Dalam Pengembangan</h3>
                    <p class="text-on-surface-variant max-w-md mx-auto">
                        Fitur ini masih dalam tahap pengembangan. Silakan hubungi pihak Tata Usaha (TU) atau Admin Sekolah untuk mengetahui informasi tagihan dan riwayat pembayaran SPP Anda.
                    </p>
                </div>
            </section>
        </div>
