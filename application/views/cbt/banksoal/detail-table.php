                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="ganda">
                            ...
                            <?php if ($total_pg > 0) : ?>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div>
                                        <input class="check-pg-all w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed" id="all-pg"
                                               type="checkbox">
                                    ...
                                    <div class="rTableBody">
                                        ...
                                        <div class="rTableRow">
                                            <div class="rTableCell align-top">
                                                <input class="check-pg mt-1 w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed"
                        ...
                        <div class="tab-pane" id="kompleks">
                            ...
                            <?php if ($total_pg2 > 0) : ?>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div>
                                        <input class="check-pg2-all w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed" id="all-pg2"
                                               type="checkbox">
                                ...
                                <table id="table-pg2" class="table-soal table table-striped mt-3">
                                    ...
                                    foreach ($soals_pg2 as $s) :
                                        ...
                                        <tr>
                                            <td class="border-0" style="width: 30px">
                                                <input class="check-pg2 w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed"
                                                       id="<?= $s->id_soal ?>" type="checkbox" name="soal[]"
                                                       value="<?= $s->id_soal ?>" <?= $checked ?>>
                                            </td>
                                            <td class="border-0" style="width: 30px">
                        ...
                        <div class="tab-pane" id="jodoh">
                            ...
                            <?php if ($total_jodohkan > 0) : ?>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div>
                                        <input class="check-jodohkan-all w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed"
                                ...
                                <table id="table-jodohkan" class="table-soal table table-striped mt-3">
                                    ...
                                    foreach ($soals_jodohkan as $s) :
                                        ...
                                        <tr>
                                            <td class="border-0" style="width: 30px">
                                                <input class="check-jodohkan w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed"
                                                       id="<?= $s->id_soal ?>" type="checkbox" name="soal[]"
                                                       value="<?= $s->id_soal ?>" <?= $checked ?>>
                                            </td>
                                            <td class="border-0" style="width: 30px">
                        ...
                        <div class="tab-pane" id="isian">
                            ...
                            <?php if ($total_isian > 0) : ?>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div>
                                        <input class="check-isian-all w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed"
                                ...
                                <table id="table-isian" class="table-soal table table-striped mt-3">
                                    ...
                                    foreach ($soals_isian as $s) :
                                        ...
                                        <tr>
                                            <td class="border-0" style="width: 30px">
                                                <input class="check-isian w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed"
                                                       id="<?= $s->id_soal ?>" type="checkbox" name="soal[]"
                                                       value="<?= $s->id_soal ?>" <?= $checked ?>>
                                            </td>
                                            <td class="border-0" style="width: 30px">
                        ...
                        <div class="tab-pane" id="essai">
                            ...
                            <?php if ($total_essai > 0) : ?>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div>
                                        <input class="check-essai-all w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed" id="all-essai"
                                               type="checkbox">
                                ...
                                <table id="table-essai" class="table-soal table table-striped">
                                    ...
                                    foreach ($soals_essai as $s) :
                                        ...
                                        <tr>
                                            <td class="border-0" style="width: 30px">
                                                <input class="check-essai w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed"
                                                       id="<?= $s->id_soal ?>" type="checkbox" name="soal[]"
                                                       value="<?= $s->id_soal ?>" <?= $checked ?>>
                                            </td>
                                            <td class="border-0" style="width: 30px">
