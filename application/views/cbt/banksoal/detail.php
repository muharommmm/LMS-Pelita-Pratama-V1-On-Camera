                    ...
                    <div class="tab-content">
                                        ...
                                        foreach ($soals_pg as $s) :
                                            ...
                                            <div class="rTableRow">
                                                <div class="rTableCell align-top text-left" style="width: 40px;">
                                                    <input class="check-pg w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed"
                        ...
                        <div class="tab-pane table-responsive" id="essai">
                            ...
                            <?php if ($total_essai > 0) : ?>
                                ...
                                <div class="d-sm-flex justify-content-between mb-3">
                                    <div>
                                        <input class="check-essai-all w-5 h-5 appearance-auto accent-blue-600 bg-white border border-slate-400 rounded focus:ring-blue-500 cursor-pointer disabled:bg-slate-200 disabled:border-slate-300 disabled:cursor-not-allowed"
                                               id="all-essai"
                                               type="checkbox" <?=$dis?>>
