 ...
 */
?>
<!-- Custom Styles for Pelita Learning System Redesign -->
<style>
    :root {
        --color-primary: #334779;
        --color-primary-container: #dae2ff;
        --color-secondary: #855300;
        --color-secondary-container: #ffddb8;
    ...
    /* Set default fonts and background */
    body, .content-wrapper, .main-header {
        font-family: 'Inter', -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif !important;
        background-color: var(--color-background) !important;
    }
    
    h1, h2, h3, h4, h5, h6, .font-headline, .info-box .info-box-content span {
    ...
    .main-header.navbar-green .btn-success {
    ...
    .main-header.navbar-green .btn-success:hover {
        background-color: rgba(255, 255, 255, 0.25) !important;
    }

    /* Sticky Header background */
    .sticky {
        background: linear-gradient(135deg, var(--color-primary) 0%, #4b5f92 100%) !important;
        height: 240px !important;
        background-image: none !important; /* override legacy image */
    }
    ...
    /* Buttons styling */
    .btn-primary, #next.btn-primary, #prev.btn-primary {
        background-color: var(--color-primary) !important;
        border: none !important;
        color: #ffffff !important;
        border-radius: 0.5rem !important;
    ...
    .btn-primary:hover, #next.btn-primary:hover, #prev.btn-primary:hover {
        background-color: #24355a !important;
        transform: translateY(-1px);
        box-shadow: 0px 2px 8px rgba(51, 71, 121, 0.2) !important;
    }
    .btn-primary:active, #next.btn-primary:active, #prev.btn-primary:active {
        transform: translateY(0);
    }
    
    .btn-success, #next.btn-success {
    ...
    .btn-success:hover, #next.btn-success:hover {
    ...
    .container-jawaban input:checked ~ .boxmark {
        ...
        color: #ffffff !important;
        box-shadow: 0px 4px 10px rgba(51, 71, 121, 0.2) !important;
    }
    ...
    .modal-content {
        border-radius: 1rem !important;
        border: 1px solid var(--color-outline-variant) !important;
        box-shadow: 0px 12px 32px rgba(0,0,0,0.1) !important;
    }
    ...
    /* Question number buttons inside modal */
    #konten-modal .btn {
    ...
    #konten-modal .btn-outline-secondary {
        background-color: var(--color-background) !important;
        color: var(--color-on-surface-variant) !important;
        border-color: var(--color-outline-variant) !important;
    }
    #konten-modal .btn-outline-secondary:hover {
        background-color: var(--color-outline-variant) !important;
        color: var(--color-on-surface) !important;
    }
    ...
    #konten-modal .btn-primary:hover {
        background-color: #24355a !important;
    }
    
    #konten-modal .btn-primary.active {
        background-color: var(--color-secondary) !important; /* Golden Ochre */
        border-color: var(--color-secondary) !important;
        color: #ffffff !important;
    }
    
    /* Badges/Indicators for completed questions inside modal */
    #konten-modal .badge-success {
    ...
    <section class="content overlap pt-4">
        <div class="container-fluid">
            <div class="d-flex flex-column flex-md-row align-items-center justify-content-between mb-3">
                <div class="d-flex flex-column align-items-center justify-content-center text-center py-3 w-100 mb-3 mb-md-0">
                    <img src="<?= base_url() ?>/assets/img/logo.png" width="54" height="54" class="mb-2">
                    <span class="text-white font-headline font-weight-bold text-lg md:text-xl" style="font-size: 1.5rem; line-height: 1.2; font-weight: 700;">Pelita Pratama</span>
                    <span class="text-white opacity-80 text-xs md:text-sm" style="letter-spacing: 0.1em; font-weight: 600;">CBT APPLICATION</span>
                </div>
                <div class="text-center text-md-right w-100">
                    <div class="d-inline-flex align-items-center text-left" style="line-height: 1.3; background: #ffffff; padding: 8px 16px; border-radius: 0.75rem; border: 1px solid var(--color-outline-variant); box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                        <div class="pr-3">
                            <span style="display: block; font-weight: 700; color: #191c1e; font-size: 14px;"><?= $siswa->nama ?></span>
                            <span style="font-size: 11px; color: #464555;"><?= $siswa->nis ?> &bull; Kelas <?= $siswa->nama_kelas ?></span>
                        </div>
                        <img src="<?= base_url() ?>/assets/app/img/ic_graduate.png" width="36" height="36" class="rounded-circle" style="background: #f7f9fb; padding: 2px; border: 1px solid #e0e3e5;">
                    </div>
                </div>
            </div>
        </div>
