...
<div class="wrapper">
    <nav class="main-header navbar navbar-expand-md navbar-dark navbar-green border-bottom-0">
        <ul class="navbar-nav ml-2 <?= $dnone ?>" id="back">
            <li class="nav-item">
                <a href="javascript:history.back()" type="button" class="btn btn-success mr-2" id="url-back">
                    <i class="fas fa-arrow-left mr-1"></i><span class="d-none d-sm-inline-block ml-1">Kembali</span>
                </a>
                <a href="<?= base_url('dashboard') ?>" type="button" class="btn btn-success" id="url-dashboard">
                    <i class="fas fa-home mr-1"></i><span class="d-none d-sm-inline-block ml-1">Beranda</span>
                </a>
            </li>
        </ul>
        <div class="d-flex flex-column align-items-center justify-content-center text-center w-100 py-3">
            <span class="text-white font-weight-bold text-lg" style="font-size: 1.25rem; line-height: 1.2;"><?= $setting->nama_aplikasi ?></span>
            <span class="text-white-50 text-xs mt-1" style="font-size: 0.875rem; color: rgba(255, 255, 255, 0.8) !important;">Tahun Pelajaran: <?= $tp_active->tahun ?> Smt:<?= $smt_active->smt ?></span>
        </div>
