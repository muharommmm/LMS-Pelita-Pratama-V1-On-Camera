        ...
        <div class="container">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <?php foreach ($menu as $m): ?>
                                    ...
                                    $link = $m->link;
                                    $title = $m->title;
                                    if ($link === 'siswa/jadwalpelajaran') {
                                        $link = 'jadwal_fleksibel/siswa';
                                ...
                                <div class="col-lg-2 col-sm-3 col-4 mb-3">
                                    <a href="<?= base_url('ebooks') ?>">
                                        <figure class="text-center">
                                            <img class="img-fluid"
                                                 src="<?= base_url() ?>/assets/app/img/ic_book.png" width="80"
                                                 height="80" onerror="this.src='<?= base_url() ?>/assets/app/img/ic_elearning.png'"/>
                                ...
                                <div class="col-lg-2 col-sm-3 col-4 mb-3">
                                    <a href="<?= base_url('chat') ?>">
                                        <figure class="text-center">
                                            <img class="img-fluid"
                                                 src="<?= base_url() ?>/assets/app/img/ic_elearning.png" width="80"
                                                 height="80" style="filter: hue-rotate(180deg);"/>
                                            <figcaption>Obrolan</figcaption>
                                        </figure>
                                    </a>
                                </div>
                                <div class="col-lg-2 col-sm-3 col-4 mb-3">
                                    <a href="<?= base_url('spp') ?>">
                                        <figure class="text-center">
                                            <img class="img-fluid"
                                                 src="<?= base_url() ?>/assets/app/img/ic_pay.png" width="80"
                                                 height="80" onerror="this.src='<?= base_url() ?>/assets/app/img/ic_exam.png'"/>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-5">
                    ...
                    ?>
                    <div class="card card-blue my-shadow mb-3">
                        <div class="card-header text-white">
                            <div class="card-title"><i class="fas fa-calendar-alt mr-1"></i> AGENDA TERDEKAT</div>
                        </div>
                    ...
                    ?>
                    <div class="card card-teal my-shadow mb-3">
                        <div class="card-header text-white">
                            <div class="card-title">
                                <i class="fas fa-calendar-alt mr-1"></i> JADWAL KELAS HARI INI
                            </div>
                        </div>
                        <div class="card-body p-2">
                                        ...
                                        <tbody>
                                            <?php foreach ($flex_schedules as $row) : ?>
                                                <tr>
                                                    ...
                                                    <td class="align-middle"><?= htmlspecialchars($row->nama_guru) ?></td>
                                                    <td class="align-middle text-center">
                                                        <?php if ($row->jenis_kegiatan == 'Tugas') : ?>
                                                            <span class="badge badge-warning font-weight-bold"><i class="fas fa-pencil-alt mr-1"></i> Tugas Mandiri</span>
                                                        <?php elseif (!empty($row->learning_link)) : ?>
                                                            <a href="<?= htmlspecialchars($row->learning_link) ?>" target="_blank" class="btn btn-xs btn-success font-weight-bold">
                                                                <i class="fas fa-external-link-alt mr-1"></i> Masuk Kelas
                                                            </a>
                                                        <?php else : ?>
                                                ...
                                                <?php if ($row->jenis_kegiatan == 'Tugas') : ?>
                                                    <tr>
                                                        <td colspan="4" class="p-1">
                                                            <div class="alert alert-warning mb-0 p-2 small font-weight-bold text-dark">
                                                                📝 Jadwal Mengerjakan Tugas (Mandiri)
                                                            </div>
                                                        </td>
                                                    </tr>
                                                <?php endif; ?>
                            ...
                            <?php else : ?>
                                <p class="text-center text-muted m-2">Tidak ada jadwal kelas hari ini.</p>
                            <?php endif; ?>
                        </div>
                    </div>
