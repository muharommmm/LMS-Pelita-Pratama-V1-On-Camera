...
<head>
    ...
    <style>
        :root {
            --primary-color: #334779;
            --secondary-color: #855300;
            --bg-color: #f7f9fb;
        }
        ...
        h1, h2, h3, h4, h5, h6, .brand-text, .nav-header {
            font-family: 'Plus Jakarta Sans', sans-serif !important;
        }

        /* Modern Card Override */
        .card {
            border: none !important;
            border-radius: 1rem !important;
            box-shadow: 0 4px 15px rgba(0,0,0,0.03), 0 10px 30px rgba(0,0,0,0.02) !important;
    ...
    <style>
        /* 1. Hancurkan kotak palsu bentukan plugin JS (iCheck / Custom Control) */
        ...
        /* 2. Paksa bangkitkan kembali & tampilkan Checkbox Asli ke permukaan layar */
        input[type="checkbox"] {
            ...
            /* Pengaturan Ukuran & Desain Baru */
            width: 18px !important;
            height: 18px !important;
            accent-color: #1e40af !important; /* Biru Gelap kontras */
            cursor: pointer !important;
            margin: 4px !important;
            outline: 1px solid #94a3b8 !important;
        }

        /* 3. Perbaikan perataan teks di sebelah checkbox */
