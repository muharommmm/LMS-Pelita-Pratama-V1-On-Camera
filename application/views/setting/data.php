    ...
    $(document).ready(function () {
        ...
        function uploadAttach(action, data) {
            $.ajax({
                ...
                success: function (response) {
                    if (response.status) {
                        if (response.src.includes('kanan')) {
                            logoKanan = response.src;
                        } else if (response.src.includes('kiri')) {
                            logoKiri = response.src;
                        } else if (response.src.includes('tanda')) {
                            tandatangan = response.src;
                        }
                        $.toast({
                            heading: "Sukses",
                            text: "Berkas berhasil diunggah sementara",
                            icon: 'success',
                            showHideTransition: 'fade',
                            allowToastClose: true,
                            hideAfter: 3000,
                ...
                error: function (xhr, status, error) {
                    ...
                    $.toast({
                        heading: "ERROR!!",
                        text: "Koneksi gagal atau berkas tidak terbaca",
                        icon: 'error',
                        showHideTransition: 'fade',
                        allowToastClose: true,
                        hideAfter: 5000,
