...
<script>
    ...
    const menus = [
            ...
            'menu': [
                ...
                },
                {
                    ...
                    'submenu': [
                        ...
                        {'name': "Jadwal Fleksibel", 'link': "jadwal_fleksibel", 'icon': 'fa fa-calendar-alt'},
                    ]
                },
                {
        ...
        },
        {
            ...
            'menu': [
                {
                    'name': 'Keuangan (SPP)', 'link': 'spp', 'icon': 'fas fa-wallet', 'cbt': '1'
                },
                {
        ...
        },
        {
            ...
            'menu': [
                ...
                {'name': 'Kumpulan Nilai Rapor', 'link': 'bukurapor', 'icon': 'fas fa-book', 'cbt': '1'},
                {'name': 'Alumni', 'link': 'dataalumni', 'icon': 'fa fa-users', 'cbt': '1'},
            ]
        },
        {
