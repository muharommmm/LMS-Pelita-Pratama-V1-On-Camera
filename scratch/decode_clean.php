<?php
$c = file_get_contents('C:\xampp\htdocs\garuda_cbt\scratch\Kelas_model_clean.php');
...
file_put_contents('C:\xampp\htdocs\garuda_cbt\scratch\Kelas_model_clean_decoded.php', $c);
